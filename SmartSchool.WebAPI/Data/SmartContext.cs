        ...
        protected override void OnModelCreating(ModelBuilder builder){
            ...
            builder.Entity<Aluno>()
                .HasData(new List<Aluno>(){
                    ...
                    new Aluno(2, "Paula", "Isabela", "33547288"),
                    new Aluno(3, "Laura", "Antonia", "55668899"),
                    new Aluno(4, "Luiza", "Maria", "65657659"),
                    new Aluno(5, "Lucas", "Machado", "56585415"),
                    new Aluno(6, "Pedro", "Alvares", "45645545"),
                    new Aluno(7, "Paulo", "José", "98794512")
                });
